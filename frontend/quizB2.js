...
function loadQuestions() {
  fetch("https://query-api.vercel.app/B2_API")
    .then((response) => {
      if (!response.ok) {
...
function startTimer() {
  ...
  let timeRemaining = 22 * 60; // 19 phút
...
function evaluateTestResult() {
  ...
  if (score >= 32 && correctType0 === 1 && totalQuestions === 32) {
    return "Đạt"; // Thi đạt nếu đúng trên 32 câu và không sai câu type 0
  } else {
